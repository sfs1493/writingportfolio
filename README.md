...
<h2><p align="center">Hi, I'm Santino. :tea::blue_book:</h2></p>
 <p align="center"> <b>Email:</b> <a href="mailto:santinoscibelli@gmail.com">santinoscibelli@gmail.com</a> :e-mail:<br>
  <b>LinkedIn:</b> <a href="https://www.linkedin.com/in/santinoscibelli/">in/santinoscibelli</a> :wave:<br></p>
...
<b>Degrees and Certifications</b>
  ...
  <li><i>Responsive Web Design Certification, HTML5 & CSS3</i> - freeCodeCamp, January 2022</li></ul><br>
  <b>Awards</b>
  <ul class="honors">
...
<b>Technical Support and SaaS Doucumentation</b><br>
I have helped contribute technical writing content published on knowledge base websites and are used for educational purposes with public audiences utilizing digital signage software. I've enjoyed writing and learning about different educational topics, especially across academia, medical sciences, psychology, and technology. Please contact me if you would like to discuss or review any samples of technical writing work.<br>
<br>
I have contributed to marketing guides, app integration documentation, and blogs for the ScreenCloud product. In addition, I authored a brief informational piece for ScreenCloud's website from a specialist perspective on <a href="https://screencloud.com/blog/the-ultimate-guide-to-digital-signage-playlists">operational management of digital playlists here.</a> Please note, I do not take copyright ownership of these product(s) and have contributed, managed, or created technical and educational guides for these public sources for ScreenCloud software.<br>
<br>
...
I have worked with HTML and CSS programming since 2003. I am currently becoming Responsive Web Design Certified and am a remote student across web coding technology bootcamps specializing in Javascript, Python, APIs, and SQL curriculums. I enjoy learning to understand more about programming languages, best practices for clean code, and continuing to develop skills for educating or writing about responsive web topics. I am pursuing a goal to build a small portfolio of coding projects across programming languages and continue education toward web coding proficiency.<br>
<br>
<p>I strive to continously improve my technical writing development and take on new challenges in writing projects on complex code, integrations, research, or software related concepts. I use Codepen to host my repositories as I'd like to encourage an open-resource environment to support education for learning how to program or use code. I believe this is equally important in regard to other aspects of training, development, and equal accessibility for access to free educational sources.</p><br>
<br>
